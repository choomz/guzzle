...
EOT;
        ...
        try {
            ...
            $this->assertContains("v10 is not one of: v1, v2, v3", $concat);
            $this->assertContains("This value must be of type object", $concat);
        }
    }
    ...
    public function testValidatesArgs()
    {
        ...
        $concat = implode("\n", $result);
        $this->assertContains("This value must be of type string", $concat);
